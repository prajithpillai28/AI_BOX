...
import joblib
from base.data.datapostprocessing import Datapostprocessing as DP1
from base.data.datapreprocessing import Datapreprocessing as DP2
...
class ML:
    ...
    def lr(X_train,Y_train,X_test,Y_test):
        ...
        DP2.data_visualizelr(X_train,Y_train)
